...
const char* AP_SSID = "Pantera";  // your router's SSID here
const char* AP_PASS = "YEzpe93r";  // your router's password here
IPAddress staticIP(192, 168, 1, 123); // parameters below are for your static IP address, if used
